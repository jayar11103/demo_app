...
/**
 * Entity class representing movie details in the local database.
 *
 * @param id Unique identifier for the movie detail (auto-generated).
 * @param trackId Unique identifier for the associated movie.
 ...
 */
@Entity(tableName = "itunes_movie_list")
